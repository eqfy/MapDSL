...
When rendering, the canvas size you specified will then be rounded up to fit even number of tiles horizontally and vertically (for example, if you specify 3000 by 3000, the rendered canvas size will be 4096 by 4096, which is 4 by 4 tiles in the default zoom level). If you do not define a canvas size, the default is 8192 by 4096 - meaning that your x coordinate can go up to 8192, and your y coordinate can go up to 4096.
